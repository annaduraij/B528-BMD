...
class DataIO:
    ...
    def unzip_files(file_names):
        """
        Unzips the specified .gz files from the input folder to the output folder.
        Accepts either a single file name or a list of file names.

        :param file_names: A single .gz file name or a list of .gz file names to be unzipped.
        """
        ...
        for file_name in file_names:
            # Construct the full path of the source .gz file in the input folder
            source_path = os.path.join(DataIO.input_folder, file_name)
            # Remove the '.gz' extension for the output file name
    ...
    def zip_files(file_names):
        """
        Compresses the specified files from the output folder to the input folder in .gz format.
        Accepts either a single file name or a list of file names.
        ...
        for file_name in file_names:
            ...
            # Add '.gz' extension for the output file name
            output_file_name = file_name + '.gz'
            # Construct the full path of the output .gz file in the input folder
